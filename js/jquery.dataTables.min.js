...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédant"},
sEmptyTable:"Pas de données sur la table",sInfo:"Affichage de _START_ à _END_ du _TOTAL_ entrées",sInfoEmpty:"Affichage de 0 à 0 du 0 entrées",sInfoFiltered:"(filtré à partie de _MAX_ entrées en total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher_MENU_ entrées",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouvés"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
