...
-->
        ...
        <script>
            ...
            $('#EditButton').click(function() {
                if(window.isAccountEnabled == true) 
                    window.isAccountEnabled = false;
                window.isAccountEnabled = true;
                alert(isAccountEnabled);
            });
