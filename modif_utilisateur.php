            ...
            <div class="mainwrapper">
                <div class="leftpanel">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="parent active"><a href="utilisateurs.php"><i class="fa fa-user"></i> <span>Utilisateurs</span></a>
                            <ul class="children">
                                <li class="active"><a href="utilisateurs.php"> Liste des utilisateurs</a></li>
                    ...
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h4>Modifier d'un utilisateur</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                            ...
                            <div class="col-md-12"> 
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h4 class="panel-title">Modifier un utilisateur</h4>
                                    </div>
